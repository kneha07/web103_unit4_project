...
const EditCar = () => {
    ...
    if (!form) return <div style={{ textAlign: 'center', marginTop: '3rem' }}><span aria-busy="true">Loading...</span></div>
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true)
        const result = await updateCar(id, { ...form, price })
        setLoading(false)
    ...
    return (
        <div style={{ maxWidth: 700, margin: '2rem auto', padding: '0 1rem' }}>
            <article>
                <header><h2>✏️ Edit Your Car</h2></header>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div style={{ display: 'flex', gap: '1rem' }}>
                        ...
                        <button type="button" className="secondary" onClick={() => navigate(`/customcars/${id}`)}>
                            Cancel
                        </button>
                    </div>
                </form>
